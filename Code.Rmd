...
If set the survival time for the control arm to follow exponential distribution, then the hazard function under $\lambda=1,\,\gamma=1.3$ could be shown as follows:
```{r, echo = FALSE}
control_func = function(t) return(1)
treatment_func = function(t) return(0.5 * 1.3 * t ^ (1.3 - 1))
