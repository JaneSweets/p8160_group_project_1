...
### Late Effect
The hazard function under $\lambda=0.2,\,\gamma_0=3,\,\gamma_1=2.5$ could be shown as follows:
```{r, echo = FALSE}
...
early_wei_spe_graph = early_wei_spe_graph +
  geom_point(data = subset(early_wei_iddf, Specificity > 0.9), aes(color = Test), size = 2)

early_wei_spe_graph = early_wei_spe_graph +
  geom_point(data = subset(early_wei_iddf, Specificity < 0.2), aes(color = Test), size = 1.5)
